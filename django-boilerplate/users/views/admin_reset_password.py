...
from django_rest_passwordreset.signals import pre_password_reset
from atomicloops.renderers import AtomicJsonRenderer
from utils.email import send_email
from users.utils import admin_reset_password_message, admin_update_password_message
        ...
        for user in users:
            if user.eligible_for_reset() and \
                ...
                send_email(
                    ...
                    message=admin_reset_password_message(token.key),
                )
        return Response({'status': 'OK'})
...
admin_reset_password_validate_token = ResetPasswordValidateToken.as_view()
admin_reset_password_confirm = ResetPasswordConfirm.as_view()
admin_reset_password_request_token = ResetPasswordRequestToken.as_view()
